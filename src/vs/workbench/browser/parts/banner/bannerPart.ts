...
export class BannerPart extends Part implements IBannerService {
	...
	private middleItemsContainer: HTMLElement | undefined;
	...
	protected override createContentArea(parent: HTMLElement): HTMLElement {
		...
		this.middleItemsContainer = document.createElement('div');
		this.element.appendChild(this.middleItemsContainer);
